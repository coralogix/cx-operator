...
object Dependencies {
  val Versions = new {
    val zioK8s = "1.4.7+1-f4d09d3c-SNAPSHOT"
    val quickLens = "1.8.4"
    val sttp = "3.3.18"
  ...
  val proto = Seq(
    ...
    "com.thesamet.scalapb.common-protos" %% "proto-google-common-protos-scalapb_0.10" % Versions.protos % "protobuf",
    "com.thesamet.scalapb.common-protos" %% "proto-google-common-protos-scalapb_0.10" % Versions.protos,
