  ...
  override def renderDTOClass(
    ...
    val baseObjectType =
      if (containsStatusField) {
        val statusT = Type.Select(Term.Name(clsName), Type.Name("Status"))
        t"com.coralogix.operator.client.model.Object[$statusT]"
      } else
        t"com.coralogix.operator.client.model.Object[Nothing]"
  ...
  override def renderDTOStaticDefns(
    ...
    circe
      ...
      .map(sdefs =>
        sdefs.copy(
          extraImports =
            q"import com.coralogix.operator.client.model.Object" ::
              q"import com.coralogix.operator.client.model.primitives._" ::
              sdefs.extraImports
        )
      )
}
