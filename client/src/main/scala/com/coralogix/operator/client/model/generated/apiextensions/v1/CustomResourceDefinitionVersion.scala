...
object CustomResourceDefinitionVersion {
  implicit val encodeCustomResourceDefinitionVersion
  ...
  implicit val decodeCustomResourceDefinitionVersion: Decoder[CustomResourceDefinitionVersion] =
    new Decoder[CustomResourceDefinitionVersion] {
      final def apply(c: HCursor): Decoder.Result[CustomResourceDefinitionVersion] =
        for {
          v0 <- c.downField("additionalPrinterColumns")
                  .as[Option[Vector[CustomResourceColumnDefinition]]]
