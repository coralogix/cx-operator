...
object WebhookConversion {
  implicit val encodeWebhookConversion: Encoder.AsObject[WebhookConversion] = {
  ...
  implicit val decodeWebhookConversion: Decoder[WebhookConversion] =
    new Decoder[WebhookConversion] {
