...
object JsonSchemaProps {
  implicit val encodeJsonSchemaProps: Encoder.AsObject[JsonSchemaProps] = {
  ...
  implicit val decodeJsonSchemaProps: Decoder[JsonSchemaProps] = new Decoder[JsonSchemaProps] {
